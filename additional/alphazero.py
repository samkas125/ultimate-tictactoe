...
class AlphaZeroParallel:
    ...
    def learn(self):
        for iteration in range(self.args['num_iterations']):
            ...
            torch.save(self.model.state_dict(), f"models/model_{iteration+10}_{self.game}.pt")
            torch.save(self.optimizer.state_dict(), f"models/optimizer_{iteration+10}_{self.game}.pt")
